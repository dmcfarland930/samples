        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active" role="presentation"><a href="${pageContext.request.contextPath}/address/statefind">Find by State</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <h1>Search</h1>
                    <form method="POST" action="${pageContext.request.contextPath}/address/statefind/">
                        <fieldset class="form-group">
                            <label for="state">Enter State to Find Contact</label>
                            <input type="text" class="form-control" name="state" placeholder="${address.city}">
                        </fieldset>
