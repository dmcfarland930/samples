...
public class FlooringAdminControl {
    ...
    public FlooringAdminControl(ProductDaoInterface pDao, TaxesDaoInterface tDao){
...
//        tDao.loadRates();
    ...
    public void removeTax() {
        ...
        List<Taxes> taxesList = taxDao.getTaxesList();
    ...
    public void updateTax() {
        ...
        List<Taxes> taxList = taxDao.getTaxesList();
