 ...
 */
package com.mycompany.dowhileswimming;
...
}//At above 79 degrees, they swim for the same amount of time
//Goofus swims for an extra minute when the temp in below 79
//Gallant checks the water
//Goofus dives in without checking
//in a while loop, we check the conditions before the action
//in a do while loop, the loop will run at least once
//while loops are pretest, do while are post test
