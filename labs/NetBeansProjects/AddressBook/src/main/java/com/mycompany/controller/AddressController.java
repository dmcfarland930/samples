    ...
    public void addAddress() {
        ...
        while (addAgain == true) {
            ...
            if (firstName.equals("1")) {
                ...
                String stNumber = console.checkEmptyString("Enter the street number:", "You must fill this field.");
                String stName = console.checkEmptyString("Enter the street name:", "You must fill this field.");
...
//                            + "\n(P.O. Box, Apt #, Suite #)\nEnter 'none' to leave blank.", "You must fill this field.");
                    ...
                    newAddress.setStreetNumber(stNumber);
                    newAddress.setStreetName(stName);
        ...
        while (removeAgain == true) {
            ...
            if (firstName.equals("1")) {
                ...
                for (Address delAddress : addresses) {
                    ...
                    if (firstName.equalsIgnoreCase(delAddress.getFirstName()) && lastName.equalsIgnoreCase(delAddress.getLastName()) && stAddress.equalsIgnoreCase(delAddress.getStreetNumber())) {
                        ...
                        if (confirm == true) {
                            addressDao.delete(delAddress.getId());
                            console.readString("\nADDRESS DELETED\n");
    ...
    public void findAddressByLastName() {
        ...
        while (findAgain == true) {
            ...
            if (lastName.equals("1")) {
                ...
                foundAddresses = addressDao.searchByLastName(lastName);
    ...
    public void findAddressByCity() {
        ...
        while (findAgain == true) {
            ...
            if (city.equals("1")) {
                ...
                List<Address> foundAddresses;
                foundAddresses = addressDao.searchByCity(city);
                int addsFound = foundAddresses.size();
    ...
    public void findAddressByZip() {
        ...
        while (findAgain == true) {
            ...
            if (zip.equals("1")) {
                ...
                List<Address> foundAddresses;
                foundAddresses = addressDao.searchByZip(zip);
                int addsFound = foundAddresses.size();
...
//                Map<String, List<Address>> cityMap;
                List<Address> stateList = addressDao.searchByState(state);
                //cityMap = addressDao.searchByState(state);
...
//                    }
    ...
    public void countAdds() {
        ...
        List<Address> listOfAddresses = addressDao.list();
...
//        String fLName = "";
        ...
        while (editAgain == true) {
            addressId = console.getInteger("Enter the Address ID for the address you wish to change (Enter 0 to cancel):\n>", "That is an invalid entry!");
...
//
//                List<Address> addresses = addressDao.list();
                List<Address> foundAddresses = addressDao.list();
...
//                        addressId = console.getInteger("Enter the Address ID for the address you wish to change:\n>", "That is an invalid entry!");
                ...
                if (foundAddresses.isEmpty()) {
                    console.readString("No contacts were found with that ID!");
                } else {
//                    console.readString("Contacts Found: " + addsFound);
//                    for (Address addressInList : foundAddresses) {
//
...
//        }
        console.readString("+----------------------------+");
        console.readString("Address ID: " + address.getId());
        ...
        while (!valid) {
            ...
            switch (selection) {
                ...
                case "2":
                    ...
                    address.setStreetNumber(newStAddress);
                    addressDao.update(address);
                    console.readString("\nAddress updated!");
                    valid = true;
                    break;
