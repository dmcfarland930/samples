        ...
        if (this.userChoice.equals("add student") || this.userChoice.equals("1")) {
            ...
            while (!valid) {
                ...
                if (students.containsKey(this.studentName)) {
                    ...
                    console.readString("Student not found!");
                }
            }
            ...
            while (go == true) {
                ...
                if (students.containsKey(this.studentName)) {
                    ...
                    if(scores.isEmpty()){
                        console.readString(" has no grades yet!"); 
                    }else{
                        System.out.print(":");
                    ...
                    for (String keys : this.studentNames) {
                        ...
                        console.readString("Average all: " + avgAll);
                    }//end key print
                } else {
                    console.readString("\nStudent not found!");
                }//end if else
    ...
    public void showHighQuizScores(Map students) {
        ...
        for (String keys : this.studentNames) {
            ...
            for (Double quizScore : scores) {
                ...
                console.readString("Avg: " + quizScore);
            }//end value print
