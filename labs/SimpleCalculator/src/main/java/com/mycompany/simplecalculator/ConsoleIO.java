...
public class ConsoleIO {
    ...
    public ConsoleIO(SimpleCalculator sc) {
        this.sc = sc;
    }
    ...
    public void sameLineTwoInts() {

        int value = Math.round(string.length() / 2);

        String str2 = string.substring(0, value);
        String str3 = string.substring(value + 1, string.length());
